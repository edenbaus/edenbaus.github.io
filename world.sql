CREATE TABLE world (name varchar(50) NOT NULL PRIMARY KEY, continent varchar(60) NULL, area decimal(10,0) NULL, population decimal(11,0) NULL, gdp decimal(14,0) NULL, capital varchar(60) NULL, tld varchar(5) NULL, flag varchar(255) NULL, INDEX(continent));
...
INSERT INTO world VALUES ("Algeria",'Africa',2381741,38700000,2.07E+11,"Algiers",".dz","//upload.wikimedia.org/wikipedia/commons/7/77/Flag_of_Algeria.svg");
...
INSERT INTO world VALUES ("Angola",'Africa',1246700,19183590,1.16E+11,"Luanda",".ao","//upload.wikimedia.org/wikipedia/commons/9/9d/Flag_of_Angola.svg");
...
INSERT INTO world VALUES ("Argentina",'South America',2780400,42669500,4.77E+11,"Buenos Aires",".ar","//upload.wikimedia.org/wikipedia/commons/1/1a/Flag_of_Argentina.svg");
...
INSERT INTO world VALUES ("Australia",'Oceania',7692024,23545500,1.56E+12,"Canberra",".au","//upload.wikimedia.org/wikipedia/commons/b/b9/Flag_of_Australia.svg");
INSERT INTO world VALUES ("Austria",'Europe',83871,8504850,3.94E+11,"Vienna",".at","//upload.wikimedia.org/wikipedia/commons/4/41/Flag_of_Austria.svg");
...
INSERT INTO world VALUES ("Bahamas",'Caribbean',null,351461,8043000000,"Nassau",".bs","//upload.wikimedia.org/wikipedia/commons/9/93/Flag_of_the_Bahamas.svg");
...
INSERT INTO world VALUES ("Bangladesh",'Asia',147570,156557000,1.27E+11,"Dhaka",".bd","//upload.wikimedia.org/wikipedia/commons/f/f9/Flag_of_Bangladesh.svg");
...
INSERT INTO world VALUES ("Belgium",'Europe',30528,11198638,4.83E+11,"City of Brussels",".be","//upload.wikimedia.org/wikipedia/commons/6/65/Flag_of_Belgium.svg");
...
INSERT INTO world VALUES ("Brazil",'South America',8515767,202794000,2.25E+12,"Brasília",".br","//upload.wikimedia.org/wikipedia/commons/0/05/Flag_of_Brazil.svg");
...
INSERT INTO world VALUES ("Canada",'North America',9984670,35427524,1.59E+12,"Ottowa",".ca","//upload.wikimedia.org/wikipedia/en/c/cf/Flag_of_Canada.svg");
...
INSERT INTO world VALUES ("Chile",'South America',756102,17773000,2.68E+11,"Santiago",".cl","//upload.wikimedia.org/wikipedia/commons/7/78/Flag_of_Chile.svg");
INSERT INTO world VALUES ("China",'Asia',9596961,1365370000,8.36E+12,"Beijing",".cn","//upload.wikimedia.org/wikipedia/commons/f/fa/Flag_of_the_People%27s_Republic_of_China.svg");
INSERT INTO world VALUES ("Colombia",'South America',1141748,47662000,3.70E+11,"Bogotá",".co","//upload.wikimedia.org/wikipedia/commons/2/21/Flag_of_Colombia.svg");
...
INSERT INTO world VALUES ("Congo, Democratic Republic of",'Africa',null,69360000,null,"Kinshasa",".cd","//upload.wikimedia.org/wikipedia/commons/6/6f/Flag_of_the_Democratic_Republic_of_the_Congo.svg");
...
INSERT INTO world VALUES ("Czech Republic",'Europe',78865,10517400,1.96E+11,"Prague",".cz","//upload.wikimedia.org/wikipedia/commons/c/cb/Flag_of_the_Czech_Republic.svg");
INSERT INTO world VALUES ("Denmark",'Europe',43094,5634437,3.15E+11,"Copenhagen",".dk","//upload.wikimedia.org/wikipedia/commons/9/9c/Flag_of_Denmark.svg");
...
INSERT INTO world VALUES ("Egypt",'Asia',1002450,86736900,2.55E+11,"Cairo",".eg","//upload.wikimedia.org/wikipedia/commons/f/fe/Flag_of_Egypt.svg");
...
INSERT INTO world VALUES ("Finland",'Europe',338424,5458038,2.47E+11,"Helsinki",".fi","//upload.wikimedia.org/wikipedia/commons/b/bc/Flag_of_Finland.svg");
INSERT INTO world VALUES ("France",'Europe',640679,65906000,2.61E+12,"Paris",".fr","//upload.wikimedia.org/wikipedia/commons/c/c3/Flag_of_France.svg");
...
INSERT INTO world VALUES ("Germany",'Europe',357114,80716000,3.43E+12,"Bonn",".de","//upload.wikimedia.org/wikipedia/commons/b/ba/Flag_of_Germany.svg");
...
INSERT INTO world VALUES ("Greece",'Europe',131990,11123034,2.49E+11,"Athens",".gr","//upload.wikimedia.org/wikipedia/commons/5/5c/Flag_of_Greece.svg");
...
INSERT INTO world VALUES ("Hungary",'Europe',93028,9879000,1.25E+11,"Budapest",".hu","//upload.wikimedia.org/wikipedia/commons/c/c1/Flag_of_Hungary.svg");
...
INSERT INTO world VALUES ("India",'Asia',3166414,1246160000,1.88E+12,"New Delhi",".in","//upload.wikimedia.org/wikipedia/commons/4/41/Flag_of_India.svg");
INSERT INTO world VALUES ("Indonesia",'Asia',1904569,252164800,8.78E+11,"Jakarta",".id","//upload.wikimedia.org/wikipedia/commons/9/9f/Flag_of_Indonesia.svg");
INSERT INTO world VALUES ("Iran",'Asia',1648195,77552000,5.52E+11,"Tehran",".ir","//upload.wikimedia.org/wikipedia/commons/c/ca/Flag_of_Iran.svg");
INSERT INTO world VALUES ("Iraq",'Asia',438317,36004552,1.49E+11,"Baghdad",".iq","//upload.wikimedia.org/wikipedia/commons/f/f6/Flag_of_Iraq.svg");
INSERT INTO world VALUES ("Ireland",'Europe',70273,4593100,2.11E+11,"Dublin",".ie","//upload.wikimedia.org/wikipedia/commons/4/45/Flag_of_Ireland.svg");
INSERT INTO world VALUES ("Israel",'Asia',20770,8193900,2.41E+11,"Jerusalem",".il","//upload.wikimedia.org/wikipedia/commons/d/d4/Flag_of_Israel.svg");
INSERT INTO world VALUES ("Italy",'Europe',301336,60782668,2.01E+12,"Rome",".it","//upload.wikimedia.org/wikipedia/commons/0/03/Flag_of_Italy.svg");
...
INSERT INTO world VALUES ("Japan",'Asia',377930,127090000,5.96E+12,"Imperial Tokyo",".jp","//upload.wikimedia.org/wikipedia/commons/9/9e/Flag_of_Japan.svg");
...
INSERT INTO world VALUES ("Kazakhstan",'Europe',2724900,17244000,2.03E+11,"Astana",".kz","//upload.wikimedia.org/wikipedia/commons/d/d3/Flag_of_Kazakhstan.svg");
...
INSERT INTO world VALUES ("Kuwait",'Asia',17818,3065850,1.83E+11,"Kuwait City",".kw","//upload.wikimedia.org/wikipedia/commons/a/aa/Flag_of_Kuwait.svg");
...
INSERT INTO world VALUES ("Malaysia",'Asia',330803,30177000,3.05E+11,"Kuala Lumpur",".my","//upload.wikimedia.org/wikipedia/commons/6/66/Flag_of_Malaysia.svg");
...
INSERT INTO world VALUES ("Mexico",'North America',1964375,119713203,1.18E+12,"Mexico City",".mx","//upload.wikimedia.org/wikipedia/commons/f/fc/Flag_of_Mexico.svg");
INSERT INTO world VALUES ("Micronesia, Federated States of",'Oceania',null,101351,327000000,"Palikir",".fm","//upload.wikimedia.org/wikipedia/commons/e/e4/Flag_of_the_Federated_States_of_Micronesia.svg");
...
INSERT INTO world VALUES ("Netherlands",'Europe',41543,16857500,8.01E+11,"Amsterdam",".nl","//upload.wikimedia.org/wikipedia/commons/2/20/Flag_of_the_Netherlands.svg");
INSERT INTO world VALUES ("New Zealand",'Oceania',270467,4538520,1.71E+11,"Wellington",".nz","//upload.wikimedia.org/wikipedia/commons/3/3e/Flag_of_New_Zealand.svg");
...
INSERT INTO world VALUES ("Nigeria",'Africa',923768,178517000,2.86E+11,"Abuja",".ng","//upload.wikimedia.org/wikipedia/commons/7/79/Flag_of_Nigeria.svg");
...
INSERT INTO world VALUES ("Norway",'Europe',323802,5124383,5.00E+11,"Oslo",".no","//upload.wikimedia.org/wikipedia/commons/d/d9/Flag_of_Norway.svg");
...
INSERT INTO world VALUES ("Pakistan",'Asia',881912,188020000,2.15E+11,"Islamabad",".pk","//upload.wikimedia.org/wikipedia/commons/3/32/Flag_of_Pakistan.svg");
...
INSERT INTO world VALUES ("Peru",'South America',1285216,30475144,2.05E+11,"Lima",".pe","//upload.wikimedia.org/wikipedia/commons/c/cf/Flag_of_Peru.svg");
INSERT INTO world VALUES ("Philippines",'Asia',342353,99804200,2.50E+11,"Manila",".ph","//upload.wikimedia.org/wikipedia/commons/9/99/Flag_of_the_Philippines.svg");
INSERT INTO world VALUES ("Poland",'Europe',312679,38496000,4.90E+11,"Warsaw",".pl","//upload.wikimedia.org/wikipedia/commons/1/12/Flag_of_Poland.svg");
INSERT INTO world VALUES ("Portugal",'Europe',92090,10477800,2.12E+11,"Lisbon",".pt","//upload.wikimedia.org/wikipedia/commons/5/5c/Flag_of_Portugal.svg");
INSERT INTO world VALUES ("Qatar",'Asia',11586,2174035,1.92E+11,"Doha",".qa","//upload.wikimedia.org/wikipedia/commons/6/65/Flag_of_Qatar.svg");
INSERT INTO world VALUES ("Romania",'Europe',238391,19942642,1.69E+11,"Bucharest",".ro","//upload.wikimedia.org/wikipedia/commons/7/73/Flag_of_Romania.svg");
INSERT INTO world VALUES ("Russia",'Eurasia',17125242,146000000,2.03E+12,"Moscow",".ru","//upload.wikimedia.org/wikipedia/commons/f/f3/Flag_of_Russia.svg");
...
INSERT INTO world VALUES ("Saudi Arabia",'Asia',2149690,29994272,7.11E+11,"Riyadh",".sa","//upload.wikimedia.org/wikipedia/commons/0/0d/Flag_of_Saudi_Arabia.svg");
...
INSERT INTO world VALUES ("Singapore",'Asia',710,5399200,2.77E+11,"Singapore",".sg","//upload.wikimedia.org/wikipedia/commons/4/48/Flag_of_Singapore.svg");
...
INSERT INTO world VALUES ("South Africa",'Africa',1221037,52981991,3.84E+11,"Pretoria",".za","//upload.wikimedia.org/wikipedia/commons/a/af/Flag_of_South_Africa.svg");
INSERT INTO world VALUES ("South Korea",'Asia',100210,50423955,1.13E+12,"Seoul",".kr","//upload.wikimedia.org/wikipedia/commons/0/09/Flag_of_South_Korea.svg");
...
INSERT INTO world VALUES ("Spain",'Europe',505992,46609700,1.32E+12,"Madrid",".es","//upload.wikimedia.org/wikipedia/commons/9/9a/Flag_of_Spain.svg");
...
INSERT INTO world VALUES ("Sweden",'Europe',450295,9675885,5.24E+11,"Stockholm",".se","//upload.wikimedia.org/wikipedia/commons/4/4c/Flag_of_Sweden.svg");
INSERT INTO world VALUES ("Switzerland",'Europe',41284,8160900,6.31E+11,"Bern",".ch","//upload.wikimedia.org/wikipedia/commons/f/f3/Flag_of_Switzerland.svg");
...
INSERT INTO world VALUES ("Thailand",'Asia',513120,64456700,3.86E+11,"Bangkok",".th","//upload.wikimedia.org/wikipedia/commons/a/a9/Flag_of_Thailand.svg");
...
INSERT INTO world VALUES ("Turkey",'Asia',783562,76667864,7.88E+11,"Ankara",".tr","//upload.wikimedia.org/wikipedia/commons/b/b4/Flag_of_Turkey.svg");
...
INSERT INTO world VALUES ("Ukraine",'Europe',603500,43009258,1.76E+11,"Kiev",".ua","//upload.wikimedia.org/wikipedia/commons/4/49/Flag_of_Ukraine.svg");
INSERT INTO world VALUES ("United Arab Emirates",'Asia',83600,9446000,3.84E+11,"Abu Dhabi",".ae","//upload.wikimedia.org/wikipedia/commons/c/cb/Flag_of_the_United_Arab_Emirates.svg");
INSERT INTO world VALUES ("United Kingdom",'Europe',242900,64105700,2.47E+12,"London",".uk","//upload.wikimedia.org/wikipedia/commons/a/ae/Flag_of_the_United_Kingdom.svg");
INSERT INTO world VALUES ("United States",'North America',9826675,318320000,1.62E+13,"Washington, D.C.",".us","//upload.wikimedia.org/wikipedia/commons/a/a4/Flag_of_the_United_States.svg");
